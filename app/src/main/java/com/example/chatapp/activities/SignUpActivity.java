     ...
     loading(true);
        ...
        database.collection(Constants.KEY_COLLECTION_USERS)
                ...
                .addOnSuccessListener(documentReference -> {
                  ...
                  preferenceManager.putStrings(Constants.KEY_USER_ID,documentReference.getId());
                  preferenceManager.putStrings(Constants.KEY_NAME,binding.inputName.getText().toString());
                  preferenceManager.putStrings(Constants.KEY_IMAGE,encodedImage);
